...
PATH_TO_JSON_MAPPING = "data/bird2int_pretraintrain_prev_comps_xc_alltaxonomy_nosmall10sp_and_2025.json"
PRECOMPUTE = False
...
CONFIG = {
    "seed": 1243,
    "df_path": "data/train_and_prev_comps_extendedv1_pruneSL_XCallyearstaxonomy_snipet03042025_hdf5_nosmall10sp_no2025.csv",
    "split_path": "data/cv_split_20_folds_train_and_prev_comps_extendedv1_pruneSL_XCallyearstaxonomy_snipet03042025_hdf5_nosmall10sp_no2025.npy",
    "exp_name": "eca_nfnet_l0_Exp_noamp_64bs_5sec_mixupP05_RandomFiltering_Radamlr1e4_CosBatchLR1e6_Epoch50_SpecAugV1_FocalBCELoss_Full_PretrainPrevCompSp10_XCAllTaxonomy",
    ...
    "train_function_args": {
        ...
        "callbacks": lambda: [
            ROC_AUC_Score(
                ...
                use_sigmoid=False,
                label_str2int_mapping_path=PATH_TO_JSON_MAPPING,
                scored_bird_path="data/sb_pretraintrain_prev_comps_xc_alltaxonomy_speciesfrom100.json",
            )
        ],
        "n_epochs": N_EPOCHS,
