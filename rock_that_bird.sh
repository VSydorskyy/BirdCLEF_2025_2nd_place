...
# -----------------------------
# Download data and prepare dirs
# -----------------------------
cd data

# Download 2023 year data
...
# Download 2025 year data and extras
...
# Reconstruct and unzip soundscapes_nocall
...
# Move relevant audio data to main data dir
