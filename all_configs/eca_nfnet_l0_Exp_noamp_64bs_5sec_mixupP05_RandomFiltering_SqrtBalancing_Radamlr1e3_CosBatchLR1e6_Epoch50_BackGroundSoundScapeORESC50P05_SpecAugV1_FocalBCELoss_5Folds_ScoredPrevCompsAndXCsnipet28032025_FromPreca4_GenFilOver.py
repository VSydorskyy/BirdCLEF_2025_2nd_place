...
CONFIG = {
    "seed": 1243,
    "df_path": "data/train_and_prev_comps_extendedv1_pruneSL_XConly2025_snipet28032025_hdf5.csv",
    "split_path": "data/cv_split_base_and_prev_comps_XCsnipet28032025_group_allbirds_hdf5.npy",
    "exp_name": "eca_nfnet_l0_Exp_noamp_64bs_5sec_mixupP05_RandomFiltering_SqrtBalancing_Radamlr1e3_CosBatchLR1e6_Epoch50_BackGroundSoundScapeORESC50P05_SpecAugV1_FocalBCELoss_5Folds_ScoredPrevCompsAndXCsnipet28032025_FromPreca4_GenFilOver",
    ...
    "train_function_args": {
        ...
        "train_dataset_config": {
            ...
            "filename_change_mapping": {
                ...
                "add_train_audio_andrii_sample_48khz": "add_train_audio_andrii_sample_48khz",
            },
            ...
            "add_df_paths": ["data/andrii_meta_filtered_oversampled.csv"],
        },
        ...
        "use_sampler": True,
        "pretrain_config": {"backbone_path": "data/bird_clef_2024_pretrained_models/eca_nfnet_l0_Pretrainversion1.pth"},
    },
}
