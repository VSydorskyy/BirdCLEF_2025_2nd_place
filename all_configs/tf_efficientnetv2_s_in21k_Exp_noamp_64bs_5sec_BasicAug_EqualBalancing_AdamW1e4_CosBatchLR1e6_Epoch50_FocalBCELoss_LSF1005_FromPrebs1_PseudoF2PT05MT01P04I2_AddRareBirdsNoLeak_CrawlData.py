...
CONFIG = {
    ...
    "exp_name": "tf_efficientnetv2_s_in21k_Exp_noamp_64bs_5sec_BasicAug_EqualBalancing_AdamW1e4_CosBatchLR1e6_Epoch50_FocalBCELoss_LSF1005_FromPrebs1_PseudoF2PT05MT01P04I2_AddRareBirdsNoLeak_CrawlData",
    ...
    "train_function_args": {
        ...
        "train_dataset_config": {
            ...
            "filename_change_mapping": {
                ...
                "add_train_audio_crawl": "add_train_audio_crawl",
            },
            ...
            "add_df_paths": ["data/birdclef_2025_crawl_dataset/archive/metadata_filtered_extended.csv"],
