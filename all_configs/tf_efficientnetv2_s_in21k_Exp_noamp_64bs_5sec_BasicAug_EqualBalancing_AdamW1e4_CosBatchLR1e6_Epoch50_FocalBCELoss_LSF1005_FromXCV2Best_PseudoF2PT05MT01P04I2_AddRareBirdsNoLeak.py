...
CONFIG = {
    ...
    "exp_name": "tf_efficientnetv2_s_in21k_Exp_noamp_64bs_5sec_BasicAug_EqualBalancing_AdamW1e4_CosBatchLR1e6_Epoch50_FocalBCELoss_LSF1005_FromXCV2Best_PseudoF2PT05MT01P04I2_AddRareBirdsNoLeak",
    ...
    "train_function_args": {
        ...
        "use_sampler": True,
        "pretrain_config": {
            "backbone_path": "data/bird_clef_2025_pretrained_models/tf_efficientnetv2_s_in21k_pretrain_from_bigXCV2_best.ckpt"
        },
    },
}
