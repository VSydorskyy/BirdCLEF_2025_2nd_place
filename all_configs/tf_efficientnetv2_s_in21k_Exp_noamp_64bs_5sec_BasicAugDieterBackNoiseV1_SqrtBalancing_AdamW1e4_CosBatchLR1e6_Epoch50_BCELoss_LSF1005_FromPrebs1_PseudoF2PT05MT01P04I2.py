...
CONFIG = {
    ...
    "exp_name": "tf_efficientnetv2_s_in21k_Exp_noamp_64bs_5sec_BasicAugDieterBackNoiseV1_SqrtBalancing_AdamW1e4_CosBatchLR1e6_Epoch50_BCELoss_LSF1005_FromPrebs1_PseudoF2PT05MT01P04I2",
                ...
                [
                    OneOf(
                        [
                            ...
                            BackgroundNoise(
                                p=0.5,
                                background_regex="data/dieter_background_noise/**/*.ogg",
                                glob_recursive=True,
                                normalize=LATE_NORMALIZE,
                                precompute=False,
                            ),
