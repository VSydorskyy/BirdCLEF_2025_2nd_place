...
CONFIG = {
    ...
    "exp_name": "eca_nfnet_l0_Exp_noamp_64bs_5sec_BasicAug_SqrtBalancing_Radamlr1e3_CosBatchLR1e6_Epoch50_FocalBCELoss_LSF1005_FromXCV2Best_PseudoF2PT05MT01P04I2_MinorOverSampleV1_OOFPI2M2MinP05",
    ...
    "train_function_args": {
        ...
        "train_dataset_config": {
            ...
            "oof_sampling_config": {"trim_min_prob": 0.1, "sampling_prob": 0.4, "acceptance_prob": 0.5},
        ...
        "use_sampler": True,
        "pretrain_config": {
            "backbone_path": "data/bird_clef_2025_pretrained_models/eca_nfnet_l0_pretrain_from_bigXCV2_best.ckpt"
        },
    },
}
