...
CONFIG = {
    ...
    "exp_name": "tf_efficientnetv2_b2_Exp_noamp_64bs_5sec_BasicAug_EqualBalancing_AdamW1e3_CosBatchLR1e5_Epoch50_FocalBCELoss_LSF1005_FromPreefb2Fer_PseudoF2PT05MT01P04I2",
    ...
    "train_function_args": {
        ...
        "optimizer_init": lambda model: torch.optim.AdamW(model.parameters(), lr=1e-3, eps=1e-8, betas=(0.9, 0.999)),
        ...
        "use_sampler": True,
        "pretrain_config": {
            "backbone_path": "data/bird_clef_2024_pretrained_models/tf_efficientnetv2_b2_in1k_FernandoSpec_Pretrainversion1.pth"
        },
    },
}
