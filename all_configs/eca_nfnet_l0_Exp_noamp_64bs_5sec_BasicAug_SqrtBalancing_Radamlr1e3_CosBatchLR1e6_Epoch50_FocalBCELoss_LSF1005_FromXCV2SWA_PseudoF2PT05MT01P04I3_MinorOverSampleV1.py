...
CONFIG = {
    ...
    "exp_name": "eca_nfnet_l0_Exp_noamp_64bs_5sec_BasicAug_SqrtBalancing_Radamlr1e3_CosBatchLR1e6_Epoch50_FocalBCELoss_LSF1005_FromXCV2SWA_PseudoF2PT05MT01P04I3_MinorOverSampleV1",
    ...
    "train_function_args": {
        ...
        "use_sampler": True,
        "pretrain_config": {
            "backbone_path": "data/bird_clef_2025_pretrained_models/eca_nfnet_l0_pretrain_from_bigXCV2_swa.ckpt"
        },
    },
}
