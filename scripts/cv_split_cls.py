...
def collect_args():
    ...
    parser.add_argument(
        "--duplicate_rare_species_in_all_folds",
        default=False,
        action="store_true",
        help="Whether to duplicate rare species in all folds",
    )
    parser.add_argument(
        "--remove_duplicates_from_val",
        default=False,
        action="store_true",
        help="Whether to remove duplicates from validation set. Should be used with --all_species_in_all_folds or --duplicate_rare_species_in_all_folds",
    )
...
if __name__ == "__main__":
    ...
    assert not (
        args.all_species_in_all_folds and args.duplicate_rare_species_in_all_folds
    ), "Cannot use both options at the same time"
    assert not (
        args.remove_duplicates_from_val
        and not (args.all_species_in_all_folds or args.duplicate_rare_species_in_all_folds)
    ), "Option --remove_duplicates_from_val should be used with --all_species_in_all_folds or --duplicate_rare_species_in_all_folds"
    ...
    if args.all_species_in_all_folds or args.duplicate_rare_species_in_all_folds:
        ...
        if args.duplicate_rare_species_in_all_folds:
